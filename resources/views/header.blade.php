			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Ngõ 69 Triều Khúc Thanh Xuân Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0974608084</a></li>
					</ul>
				</div>
					...
					<ul class="l-inline ov">
						...
						<li><a href="#">Loại Sản Phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="{{route('loai-san-pham',$type->id)}}">{{$type->name}}</a></li>
								@endforeach
							</ul>
						</li>
